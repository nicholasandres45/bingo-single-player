...
export default function BuyCards({ betAmount, setBetAmount, cardCount, setCardCount, onBuyCards, gameActive }) {
  ...
  return (
    <div className="flex flex-col gap-6 p-4">
      {/* Bet Amount */}
      <div>
        <p className="text-gray-400 text-xs uppercase tracking-widest mb-3">Bet Amount (ETB)</p>
            ...
            <button
              ...
              className={`
                ...
                ${betAmount === amt
                  ...
                  : 'bg-gray-900 text-gray-300 border-2 border-gray-700 hover:border-red-700'}
      ...
      <div className="flex justify-between items-center border-t border-gray-800 pt-4">
        ...
        <span className="text-red-400 font-bold text-xl">{totalCost} ETB</span>
      </div>
      ...
      {/* Potential Wins */}
      <div>
        <p className="text-red-400 text-xs uppercase tracking-widest font-bold mb-3">Potential Wins</p>
      ...
      <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
        ...
        <div className="flex flex-col gap-2">
          {[
            ...
            <div key={label} className="flex justify-between items-center">
              <span className="text-gray-400 text-sm">{label}</span>
              <span className={`font-bold text-sm ${special ? 'text-yellow-400' : 'text-red-400'}`}>{mult}</span>
            </div>
          ))}
        </div>
      </div>
